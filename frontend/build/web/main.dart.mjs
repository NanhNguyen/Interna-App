...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1365: (x0,x1) => x0.getItem(x1),
      _1366: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      _1367: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      _1368: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      _1369: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      _1370: (x0,x1,x2) => x0.exportKey(x1,x2),
      _1371: (x0,x1,x2) => x0.setItem(x1,x2),
      _1372: (x0,x1) => x0.getRandomValues(x1),
      _1373: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      _1374: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      _1375: Date.now,
      ...
      _1573: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1574: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1580: (x0,x1,x2) => x0.open(x1,x2),
      _1581: x0 => x0.abort(),
      _1582: x0 => x0.getAllResponseHeaders(),
      ...
      _1621: () => globalThis.document,
      _1642: (x0,x1) => { x0.src = x1 },
      _1643: x0 => x0.naturalWidth,
      _1644: x0 => x0.naturalHeight,
      _1660: x0 => x0.status,
      _1661: (x0,x1) => { x0.responseType = x1 },
      _1663: x0 => x0.response,
      ...
      _3070: (x0,x1) => { x0.width = x1 },
      _3072: (x0,x1) => { x0.height = x1 },
      _3493: () => globalThis.window,
      _3538: x0 => x0.history,
      _3811: x0 => x0.isSecureContext,
      _3814: x0 => x0.crypto,
      ...
      _8113: x0 => x0.type,
      _8120: x0 => x0.name,
      _8121: x0 => x0.lastModified,
      _8126: x0 => x0.length,
      _8629: x0 => x0.url,
      _8631: x0 => x0.status,
      _8633: x0 => x0.statusText,
      _8634: x0 => x0.headers,
      _8635: x0 => x0.body,
      _12263: x0 => x0.name,
      _12267: x0 => x0.subtle,
